...
export default function HospitalLogin() {
  ...
  return (
    <div className="max-w-md mx-auto bg-zinc-900/80 backdrop-blur-xl p-8 rounded-xl shadow-lg mt-20 border-t-4 border-purple-600">
      <h2 className="text-2xl font-bold mb-6 text-center text-white">Hospital Admin Login</h2>
      ...
      <div className="mt-8 pt-6 border-t border-gray-100 space-y-3">
        <button 
           ...
           className="w-full bg-gray-100 hover:bg-gray-200 text-zinc-300 font-semibold py-2 rounded transition text-sm"
        >
