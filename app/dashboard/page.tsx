...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-zinc-950 flex flex-col items-center justify-center p-4 overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-6 left-6 z-50">
        <Link href="/" className="flex items-center gap-2 text-sm font-semibold text-zinc-600 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white transition-colors bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md px-4 py-2 border border-zinc-200 dark:border-zinc-800 rounded-full shadow-sm hover:scale-105 active:scale-95 duration-200">
          <ArrowLeft size={16} />
      ...
      <main className="relative w-full max-w-7xl z-10 flex flex-col items-center justify-center py-20 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 w-full mt-8">
           ...
           {/* Patient Portal Card */}
           <div className="bg-white dark:bg-zinc-950/40 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-6 flex flex-col items-start transition-all duration-300 hover:bg-zinc-50 dark:hover:bg-zinc-900/50 hover:border-zinc-300 dark:hover:border-zinc-700/80 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] group">
              <div className="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-zinc-500 dark:text-zinc-400 mb-6 group-hover:text-zinc-800 dark:group-hover:text-zinc-200 transition-colors shadow-sm">
           ...
           {/* Doctor Portal Card */}
           <div className="bg-white/70 dark:bg-zinc-950/40 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-6 flex flex-col items-start transition-all duration-300 hover:bg-zinc-50 dark:hover:bg-zinc-900/50 hover:border-zinc-300 dark:hover:border-zinc-700/80 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] group">
              <div className="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-zinc-500 dark:text-zinc-400 mb-6 group-hover:text-zinc-800 dark:group-hover:text-zinc-200 transition-colors shadow-sm">
                 <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
